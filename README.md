...
This guide is completely replaced and superceded by my new Foxhole Multiboxer program, which is currently in testing, but fully functional. Help test it [here](https://discord.com/channels/492127642544373770/1469961303367094283). (Posted 8/24/2026)
...
4. Important! Every time you launch a Foxhole game, or once all of them are launched, you must tab into OpenMultiBoxer, and select your profile from the profile dropdown to resize all the game windows. They will not auto resize. If your game windows ever get out of position, just click the profile again.
...
7. Play around with Window layout in OMB to get a layout you like. I myself initially used a 'Stack-All' layout, and used a keybind to switch between windows. However, I've found being able to see every window at once to be much easier in general. You can have one larger window and many smaller ones, and use hotkeys to switch them around. Try using the `Auto` button in the Window layout.
